...
- *Implemented By:* <a href="#@time-loop/cdk-named-environments.IShard">IShard</a>

#### Methods <a name="Methods" id="Methods"></a>

| **Name** | **Description** |
| --- | --- |
| <code><a href="#@time-loop/cdk-named-environments.IShard.toString">toString</a></code> | *No description.* |

---

##### `toString` <a name="toString" id="@time-loop/cdk-named-environments.IShard.toString"></a>
